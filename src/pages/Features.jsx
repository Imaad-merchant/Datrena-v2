    ...
    <div className="bg-black min-h-screen text-white">
      <nav className="flex items-center justify-between px-10 py-5 z-10 relative">
        ...
        <div className="flex items-center gap-10">
          ...
          <Link to="/Features" className="text-white text-sm transition-colors">Features</Link>
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-10">
        ...
        <p className="text-gray-500 text-sm max-w-sm">
          We're still building this page. Check back soon for a full breakdown of everything Datrena has to offer.
        </p>
      </div>
    </div>
  );
